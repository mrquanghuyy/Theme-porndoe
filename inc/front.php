            ...
            jQuery.ajax({
                ...
                success: function(res) {
                    ...
                    $.each(data, function(key, value){
                        $('#result').append('<a href="'+value.slug+'"><div class="rowsearch"> <div class="column lefts"> <img src="'+value.image+'" alt="'+value.title+'" width="40" /> </div> <div class="column rights"><p> '+value.title+' ' + '</p> '+value.original_title+'| '+value.year+' </div> </div></a>' )
                    });
                }
            });
